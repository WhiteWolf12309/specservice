...
const PriceList = () => {
  const updateUISortedPriceList = () => {
    ...
    if (
      sortedPriceList.length < 12 ||
      sortedPriceList.length - 12 * pageIndex.current < 12
    ) {
  ...
  const applyFiltersAndSearch = () => {
    ...
    // =================== [FILTRATION] ======================
    const filterServicesStatus =
      filterPoints["service-type-1"] ||
    ...
    if (
      searchInputValue === "" &&
      filterServicesStatus === false &&
      (priceValues.from === "" ||
        (priceValues.from === "0" && priceValues.to === "") ||
        priceValues.to === "0")
    ) {
      ...
      let newPriceList = priceList.filter(({ title }) =>
      ...
      newPriceList = newPriceList.filter(({ price }) => {
        if (
          parseInt(price, 10) > MinMaxDiap.min &&
          parseInt(price, 10) <= MinMaxDiap.max
        ) {
          return true;
        }
      });
      ...
      if (filterServicesStatus === false) {
        ...
        newPriceList = newPriceList.filter(
          ({ group }) => filterPoints[group] === true
        );
        setSortedPriceList((prev) => newPriceList);
      }
    }
  ...
  const [UISortedPriceList, setUISortedPriceList] = useState(
    initialUISortedPriceList
  );
  ...
  const setServiceType1 = () =>
    setFilterPoints({
      ...filterPoints,
      "service-type-1": !filterPoints["service-type-1"],
    });
  const setServiceType2 = () =>
    setFilterPoints({
      ...filterPoints,
      "service-type-2": !filterPoints["service-type-2"],
    });
  const setServiceType3 = () =>
    setFilterPoints({
      ...filterPoints,
      "service-type-3": !filterPoints["service-type-3"],
    });

  const setSparesEngine = () =>
    setFilterPoints({ ...filterPoints, engine: !filterPoints["engine"] });
  const setServiceElectricStacker = () =>
    setFilterPoints({
      ...filterPoints,
      "electric stacker": !filterPoints["electric stacker"],
    });
  const setServiceControlledBridge = () =>
    setFilterPoints({
      ...filterPoints,
      "controlled bridge": !filterPoints["controlled bridge"],
    });
  const setServiceHydraulics = () =>
    setFilterPoints({
      ...filterPoints,
      hydraulics: !filterPoints["hydraulics"],
    });
  const setServiceMast = () =>
    setFilterPoints({ ...filterPoints, mast: !filterPoints["mast"] });
  const setServiceTires = () =>
    setFilterPoints({ ...filterPoints, tires: !filterPoints["tires"] });
  const setServiceBattery = () =>
    setFilterPoints({ ...filterPoints, battery: !filterPoints["battery"] });
  const setServiceAnother = () =>
    setFilterPoints({ ...filterPoints, another: !filterPoints["another"] });
  ...
  const SearchItems = (e) =>
    e.code === "Enter" ? applyFiltersAndSearch() : null;
        ...
        <div className="price-list__inner">
          ...
          <div className="price-list__content">
                    ...
                    >
                      <div className="element">
                        ...
                        <div className="element__text">
                          <label htmlFor="element-service-1">
                            Для транспортировщиков паллет и эл. штабелеров
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="element">
                        ...
                        />
                        <div className="element__text">
                          <label htmlFor="element-service-2">
                            Для ричтраков и электропогрузчиков
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="element">
                        ...
                        />
                        <div className="element__text">
                          <label htmlFor="element-service-3">
                            Для автопогрузчиков
                          </label>
                        </div>
                      </div>
            ...
            <div className="products">
              ...
              {UISortedPriceList.length >= 12 ? (
                <div className="products__more" onClick={addPageIndex}>
          ...
          <div className="help__text">
            <div className="content">
              ...
              запасные части высокого качества, колеса, ролики, расходные
              материалы и дополнительное оборудование для складской и
              грузоподъемной техники ведущих европейских и японских
              производителей: ТСМ, Toyota, BT, Komatsu, Mitsubishi, Nissan,
              Linde, STILL, Jungheinrich, OM, Daewoo, Doosan, Hyster, Yale,
              Crown, Nichiyu, Hyundai, CLARK, KALMAR. Более 10000 наименований
              запасных частей на складе в Москве, доставка от 2х дней.
              <p>
                Количество нормо-часов для выполнения работ носят
                ознакомительный характер. Все работы согласовываются с
                сервис-менеджером.
              </p>
            </div>
          </div>
                ...
                <div className="filter__item__content">
                  <div className="content__spare">
                    <div className="element">
                      ...
                      />
                      <div className="element__text">
                        <label htmlFor="element-service-1-mobile">
                          Для транспортировщиков паллет и эл. штабелеров
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="element">
                      ...
                      />
                      <div className="element__text">
                        <label htmlFor="element-service-2-mobile">
                          Для ричтраков и электропогрузчиков
                        </label>
                      </div>
                    </div>
              ...
              <div className="filter__item__content">
                <div className="content__spare">
                  ...
                  <div className="element">
                    ...
                    />
                    <div className="element__text">
                      <label htmlFor="element-spare-2-mobile">
                        Электроштабеллер
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="element">
                    ...
                    />
                    <div className="element__text">
                      <label htmlFor="element-spare-3-mobile">
                        Управляемый мост
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="element">
                    ...
                    />
                    <div className="element__text">
                      <label htmlFor="element-spare-8-mobile">
                        Другие запчасти
                      </label>
                    </div>
                  </div>

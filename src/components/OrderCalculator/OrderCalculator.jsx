...
const OrderCalculatorItemMobile = ({ id, title, price, count, group }) => {
    const isSpares =
        group !== "service-type-1" &&
        group !== "service-type-2" &&
        group !== "service-type-3";

    const dispatch = useDispatch();

    const addItemCountOrderCalculator = () =>
        dispatch(addProductItemCount({ id, price }));
    const substractItemCountOrderCalculator = () =>
        dispatch(substractProductItemCount({ id, price }));
    const removeItemOrderCalculator = () =>
        dispatch(removeProductItem({ id, totalPrice: price * count }));
...
const OrderCalculatorItem = ({ id, title, article, price, count, group }) => {
    ...
    const addItemCountOrderCalculator = () =>
        dispatch(addProductItemCount({ id, price, group }));
    const substractItemCountOrderCalculator = () =>
        dispatch(substractProductItemCount({ id, price, group }));
    const removeItemOrderCalculator = () =>
        dispatch(removeProductItem({ id, totalPrice: price * count, group }));
    const removeServiceOrderCalculator = () =>
        dispatch(removeService({ id, price, group }));
    ...
    return (
        <div className="products__items__item">
            ...
            {isSpares ? (
                <div className="price">
                    {(parseInt(price) * count).toLocaleString("ru")} ₽
                </div>
            ) : (
                <div className="price">{price} нормо-час</div>
            )}
                ...
                >
                    <div className="order-calculator__inner">
                        <div className="order-calculator__inner__header">
                            ...
                            >
                                <div className="header__roll-up__text">
                                    Подробнее
                                </div>
                                <img
                        ...
                        {isShowProducts && (
                            ...
                            >
                                <div className="products__header">
                                    ...
                                    <div className="products__header__article">
                                        Артикул
                                    </div>
                                    <div className="products__header__count">
                                        Кол-во (шт.)
                                    </div>
                                    <div className="products__header__price">
                                        Цена
                                    </div>
                                </div>
                        ...
                        <div className="order-calculator__inner__footer">
                            ...
                            <div className="footer__buttons">
                                ...
                                <a
                                    href="tel:+79041714528"
                                    className="footer__buttons__call"
                                >
                                    <div className="call__phone-number">
                                        +7 904 171 45 28
                                    </div>
                                    <HeaderPhone
                                        className={"call__img"}
                                ...
                                >
                                    <div className="create-cheque__text">
                                        Создать чек
                                    </div>
                                    <img src={CheckMark} />
                                </Link>
                ...
                >
                    <div className="order-calculator__mobile__inner">
                        <div className="order-calculator__mobile__inner__header">
                            ...
                            >
                                <Trash
                                    className={"header__clear__trash"}
                                    fill={"#343434"}
                                />
                            </div>
                            <div
